...
class _GoogleAuth:
    ...
    def _load_service_account(self) -> None:
        ...
        logger.info("Getting Google credentials from Bitwarden...")
        creds = get_google_credentials()

        if not creds:
            raise GoogleAuthError("Google credentials not found in Bitwarden")
    ...
    def _create_jwt(self) -> str:
        ...
        # Handle escaped newlines from JSON stored in Bitwarden
